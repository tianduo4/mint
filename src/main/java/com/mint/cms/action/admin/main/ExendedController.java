...
import com.mint.cms.manager.ExendedItemMng;
import com.mint.cms.manager.ExendedMng;
...
@Controller
public class ExendedController {
    private static final Logger log = LoggerFactory.getLogger(ExendedController.class);
