...
public class Finder {
    ...
    public String getRowCountHql() {
        return getRowCountBaseHql("order ");
    }

    public String getRowCountTotalHql(String selectSql) {
        return getRowCountTotalBaseHql("order ", selectSql);
    }

    public String getRowCountHqlByGroup() {
        return getRowCountBaseHql("group");
    }
            ...
            for (int i = 0; i < this.paramsArray.size(); i++) {
                if (this.typesArray.get(i) == null)
                    query.setParameterList((String) this.paramsArray.get(i),
                            (Object[]) this.valuesArray
                                    .get(i));
                else {
                    query.setParameterList((String) this.paramsArray.get(i),
                            (Object[]) this.valuesArray
                                    .get(i), (Type) this.typesArray.get(i));
                }
            }
        }
        return query;
